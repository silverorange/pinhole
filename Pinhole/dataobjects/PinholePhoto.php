...
class PinholePhoto extends SwatDBDataObject
{
	...
	const COMMENTS_STATUS_NORMAL = 0;
	const COMMENTS_STATUS_LOCKED = 1;
	const COMMENTS_STATUS_DISABLED = 2;
	 ...
	 * Comments status
	 *
	 * COMMENTS_STATUS_NORMAL - allows for displaying and posting of comments
	 * COMMNETS_STATUS_LOCKED - allows for only displaying of comments
	 * COMMENTS_STATUS_DISABLED - displaying and posting of comments is turned off
	 *
	 * @var integer
	 */
