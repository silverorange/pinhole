 ...
 *
 * Returns a VARCHAR containing the path string for the given tag. If the
 * tag does not exist, NULL is returned.
 */
CREATE OR REPLACE FUNCTION getPinholeTagPath(INTEGER) RETURNS VARCHAR(255) AS $$
	DECLARE
