...
// {{{ PinholePhotoTimePage

PinholePhotoTimePage = function()
{
	// time zone flydowns
...
// time zone methods
// {{{ PinholePhotoTimePage.prototype.disableTimeZoneMatching

PinholePhotoTimePage.prototype.disableTimeZoneMatching = function(e)
{
	this.match_time_zone_flydowns = false;
}

// }}}
// {{{ PinholePhotoTimePage.prototype.handleTimeZoneChange

PinholePhotoTimePage.prototype.handleTimeZoneChange = function(e)
{
